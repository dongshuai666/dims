...
!function($) {
    ...
    Dashboard1.prototype.init = function() {
        ...
        this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b', 'c'], ['平安保险', '太平洋保险', '人保保险'], ['#5fbeaa', '#5d9cec', '#ebeff2']);
        ...
        this.createAreaChartDotted('morris-area-with-dotted', 0, 0, $areaDotData, 'y', ['a', 'b', 'c'], ['平安保险', '太平洋保险', '人保保险'],['#ffffff'],['#999999'], ['#5fbeaa', '#5d9cec','#ebeff2']);
